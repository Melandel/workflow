...
function! BuildWipFileForWorkItem(workItemId)
	...
	* Input fields: mainborrower.netMonthlyIncome, coborrower.netMonthlyIncome
	* Rules to test: exclusivity of the condition
	* Test plan
	...
	call add(filecontent, '* [ ] Execution context identification is challenged and clear')
