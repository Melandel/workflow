...
augroup end
let g:fzf_colors = { 'fg':      ['fg', 'Normal'], 'bg':      ['bg', 'Normal'], 'hl':      ['fg', 'Constant'], 'fg+':     ['fg', 'Constant', 'CursorColumn', 'Normal'], 'bg+':     ['bg', 'CursorLine', 'CursorColumn'], 'hl+':     ['fg', 'Ignore'], 'gutter':  ['fg', 'Comment'], 'info':    ['fg', 'PreProc'], 'border':  ['fg', 'Normal'], 'prompt':  ['fg', 'Normal'], 'pointer': ['fg', 'Constant'], 'marker':  ['fg', 'Keyword'], 'spinner': ['fg', 'Label'], 'header':  ['fg', 'Comment'] }

function! Edit(lines)"-----------------{{{
	if len(a:lines) < 2 | return | endif
	let file_or_dir = a:lines[1]
	let cmd = isdirectory(file_or_dir) ?get({'ctrl-x': 'split | Dirvish','ctrl-j': 'split | Dirvish','ctrl-v': 'vertical split | Dirvish','ctrl-k': 'vertical split | Dirvish','ctrl-t': 'tabe | Dirvish','ctrl-o': 'tabe | Dirvish'}, a:lines[0], 'Dirvish') :get({'ctrl-x': 'split','ctrl-j': 'split','ctrl-v': 'vertical split','ctrl-k': 'vertical split','ctrl-t': 'tabe','ctrl-o': 'tabe'}, a:lines[0], 'e')
...
augroup mydiagrams
	...
	autocmd FileType dot,plantuml_sequence,plantuml_activity,plantuml_class,plantuml_component,plantuml_entities,plantuml_mindmap,plantuml_sequence,plantuml_state,plantuml_usecase,plantuml_workbreakdown silent nnoremap <buffer> <Leader>w :silent w \| CompileDiagramAndShowImage png<CR>
...
augroup end
let g:OmniSharp_highlight_groups = { 'Comment': 'Comment', 	 'Identifier': 'Identifier', 'Keyword': 'Keyword', 	 'ControlKeyword': 'String', 	 'NumericLiteral': 'Number', 	 'Operator': 'Identifier', 	 'StringLiteral': 'String', 	 'StaticSymbol': 'Identifier', 'Punctuation': 'Identifier', 	 'VerbatimStringLiteral': 'String', 	 'StringEscapeCharacter': 'Special', 	 'ClassName': 'Float', 'DelegateName': 'Identifier', 'EnumName': 'Structure', 'InterfaceName': 'Character', 'StructName': 'Float', 'TypeParameterName': 'Type', 'FieldName': 'Identifier', 'EnumMemberName': 'Structure', 'ConstantName': 'Constant', 'LocalName': 'Identifier', 'ParameterName': 'Constant', 'MethodName': 'Identifier', 'ExtensionMethodName': 'Identifier', 'PropertyName': 'Identifier', 'EventName': 'Identifier', 'NamespaceName': 'Identifier', 'LabelName': 'Label', 'XmlDocCommentAttributeName': 'Comment', 	 'XmlDocCommentAttributeQuotes': 'Comment', 	 'XmlDocCommentAttributeValue': 'Comment', 	 'XmlDocCommentCDataSection': 'Comment', 	 'XmlDocCommentComment': 'Comment', 	 'XmlDocCommentDelimiter': 'Comment', 	 'XmlDocCommentEntityReference': 'Comment', 	 'XmlDocCommentName': 'Comment', 	 'XmlDocCommentProcessingInstruction': 'Comment', 	 'XmlDocCommentText': 'Comment', 	 'XmlLiteralAttributeName': 'Comment', 	 'XmlLiteralAttributeQuotes': 'Comment', 	 'XmlLiteralAttributeValue': 'Comment', 	 'XmlLiteralCDataSection': 'Comment', 	 'XmlLiteralComment': 'Comment', 	 'XmlLiteralDelimiter': 'Comment', 	 'XmlLiteralEmbeddedExpression': 'Comment', 	 'XmlLiteralEntityReference': 'Comment', 	 'XmlLiteralName': 'Comment', 	 'XmlLiteralProcessingInstruction': 'Comment', 	 'XmlLiteralText': 'Comment', 	 'RegexComment': 'Comment' 	}
let g:OmniSharp_diagnostic_exclude_paths = [ 'obj\\', '[Tt]emp\\', '\.nuget\\', '\<AssemblyInfo\.cs\>']
